                    ...
                    <div className="max-w-screen-xl mx-auto px-4 py-3 flex items-start justify-between text-white sm:items-center md:px-8">
                        <div className="flex-1 justify-center flex items-start gap-x-4 sm:items-center">
                            ...
                            <p className="font-medium p-2 ">
                                We just launched a new version of ShareUp !{' '}
                                <a
                                    
                                    className=" ml-4 font-semibold underline duration-150 hover:text-indigo-100 inline-flex items-center gap-x-1"
                                >
                                    Learn more
                        ...
                        <button onClick={closeBanner} className="p-2 rounded-lg duration-150 hover:bg-indigo-500 ring-offset-2 focus:ring">
